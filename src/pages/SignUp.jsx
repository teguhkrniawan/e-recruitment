        ...
        <div className="flex items-center justify-center bg-teal-400 h-screen background-login">
            ...
            <form className='z-10'>
                <div className="bg-white md:w-96 sm:w-32 p-5 rounded shadow-sm">
                    ...
                    <div className="group-input mt-2">
                        <label htmlFor="password" className='text-gray-700'>Fullname</label>
                        <input type="text" className='w-full outline-none bg-gray-100 text-gray-500 py-2 px-2 mt-2' placeholder='Teguh' />
                    </div>
